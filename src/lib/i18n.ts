...
const es = {
  ...
  'profile.achievementLocked': 'Aún no desbloqueado',

  'comments.title': 'Comentarios',
  'comments.empty': 'Aún no hay comentarios. ¡Sé el primero!',
  'comments.placeholder': 'Escribe un comentario sobre esta tortilla…',
  'comments.post': 'Comentar',
  'comments.loginToPost': 'Inicia sesión para comentar.',
  'comments.deleteConfirm': '¿Borrar este comentario?',
  'comments.deleteOk': 'Borrar',
  'comments.deleteCancel': 'Cancelar',
  'comments.errorPost': 'No se pudo publicar el comentario.',
  'comments.errorDelete': 'No se pudo borrar el comentario.',

  'achievement.firstVote.title': 'Estreno',
  'achievement.firstVote.description': 'Vota tu primera tortilla.',
  'achievement.tenVotes.title': 'Veterano',
  'achievement.tenVotes.description': 'Vota 10 tortillas en total.',
  'achievement.fiftyVotes.title': 'Coleccionista',
  'achievement.fiftyVotes.description': 'Vota 50 tortillas en total.',
  'achievement.streak3.title': 'En racha',
  'achievement.streak3.description': '3 tortillas consecutivas votadas.',
  'achievement.streak5.title': 'Devorador',
  'achievement.streak5.description': '5 tortillas consecutivas votadas.',
  'achievement.streak10.title': 'Inquebrantable',
...
const ca: Record<DictKey, string> = {
  ...
  'profile.achievementLocked': 'Encara no desbloquejat',

  'comments.title': 'Comentaris',
  'comments.empty': 'Encara no hi ha comentaris. Sigues el primer!',
  'comments.placeholder': 'Escriu un comentari sobre aquesta truita…',
  'comments.post': 'Comentar',
  'comments.loginToPost': 'Inicia sessió per comentar.',
  'comments.deleteConfirm': 'Esborrar aquest comentari?',
  'comments.deleteOk': 'Esborrar',
  'comments.deleteCancel': 'Cancel·lar',
  'comments.errorPost': 'No s\'ha pogut publicar el comentari.',
  'comments.errorDelete': 'No s\'ha pogut esborrar el comentari.',

  'achievement.firstVote.title': 'Estrena',
  'achievement.firstVote.description': 'Vota la teva primera truita.',
  'achievement.tenVotes.title': 'Veterà',
  'achievement.tenVotes.description': 'Vota 10 truites en total.',
  'achievement.fiftyVotes.title': 'Col·leccionista',
  'achievement.fiftyVotes.description': 'Vota 50 truites en total.',
  'achievement.streak3.title': 'En ratxa',
  'achievement.streak3.description': '3 truites consecutives votades.',
  'achievement.streak5.title': 'Devorador',
  'achievement.streak5.description': '5 truites consecutives votades.',
  'achievement.streak10.title': 'Inquebrantable',
